...
The computational complexity and rigor requires the agent to have a high level of intelligence, since it needs to optimize its location and navigation, as well as deduce the crafting recipes, and required materials. An agent lacking the intelligence would take a substantially longer time, and would often return incorrect results and place the player in danger of losing progress.
